...
//!
//! - [`builder::OutbeHasher`] -- iterated `Poseidon2` over a seed and
//!   a stream of `Fr` values. Used by entity hashes.
//!
...
//!   values. Available for binding-style commitments.
//!
...
pub use builder::{poseidon2, OutbeHasher};
